---
description: Configure the local clippos skill environment, including output directory, ratios, clip count, score threshold, and Hugging Face token status.
argument-hint: '[--output-dir ~/Documents/Clippos] [--ratios 9:16,1:1,16:9] [--clips 5] [--hf-token hf_...]'
allowed-tools: [Bash, Read, Write, AskUserQuestion]
---

Invoke the `clippos` skill's configuration workflow with the user's arguments:
$ARGUMENTS
